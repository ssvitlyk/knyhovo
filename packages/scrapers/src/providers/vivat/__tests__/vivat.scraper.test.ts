...
import { VivatScraper } from '../vivat.scraper.js';
...
describe('VivatScraper.scrape — successful pages', () => {
...
describe('VivatScraper.scrape — network errors', () => {
...
describe('VivatScraper.scrape — ScraperResult shape', () => {
