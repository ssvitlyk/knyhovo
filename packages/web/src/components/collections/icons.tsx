...
const PATHS: Readonly<Record<string, ReactNode>> = {
  ...
  knife: (
    <>
      <path d="M20 3 9 14" />
      <path d="M17.32 8.32c-1.53 1.53-4.29 2.11-5.66.74s-.8-4.13.73-5.66C13.9.98 15.25.14 16.32 1.2c1.06 1.07.22 2.42-1.32 3.95" />
      <path d="m9 14-6.16 6.16a1.5 1.5 0 0 0 2.12 2.12L11 16.24" />
    </>
  ),
  'graduation-cap': (
    <>
  ...
  baby: (
    <>
      ...
      <path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.9 0-1.5-.5-1.5-1" />
    </>
  ),
  'panels-top-left': (
    <>
